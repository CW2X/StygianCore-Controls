...
namespace StygianCoreControls
{
  public class Main : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      componentResourceManager.ApplyResources((object) this.wpanel, "wpanel");
      this.wpanel.Name = "wpanel";
      componentResourceManager.ApplyResources((object) this.pictureBox6, "pictureBox6");
      this.pictureBox6.Name = "pictureBox6";
      this.pictureBox6.TabStop = false;
      componentResourceManager.ApplyResources((object) this.wckb, "wckb");
      this.wckb.ForeColor = Color.Crimson;
      this.wckb.Name = "wckb";
      this.wckb.UseVisualStyleBackColor = true;
      this.wtime.ForeColor = Color.Crimson;
      componentResourceManager.ApplyResources((object) this.wtime, "wtime");
      this.wtime.Name = "wtime";
      componentResourceManager.ApplyResources((object) this.wflag, "wflag");
      this.wflag.Name = "wflag";
      this.wflag.TabStop = false;
      this.tt.SetToolTip((Control) this.wflag, componentResourceManager.GetString("wflag.ToolTip"));
      this.wflag.Click += new EventHandler(this.wflag_Click);
      this.wbtn.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.wbtn, "wbtn");
      this.wbtn.Name = "wbtn";
      ...
      componentResourceManager.ApplyResources((object) this.lckb, "lckb");
      ...
      componentResourceManager.ApplyResources((object) this.lflag, "lflag");
      this.lflag.Name = "lflag";
      this.lflag.TabStop = false;
      this.tt.SetToolTip((Control) this.lflag, componentResourceManager.GetString("lflag.ToolTip"));
      this.lflag.Click += new EventHandler(this.lflag_Click);
      this.lbtn.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.lbtn, "lbtn");
      this.lbtn.Name = "lbtn";
      ...
      componentResourceManager.ApplyResources((object) this.mckb, "mckb");
      this.mckb.ForeColor = Color.RoyalBlue;
      this.mckb.Name = "mckb";
      this.mckb.UseVisualStyleBackColor = true;
      this.mtime.ForeColor = Color.RoyalBlue;
      componentResourceManager.ApplyResources((object) this.mtime, "mtime");
      this.mtime.Name = "mtime";
      componentResourceManager.ApplyResources((object) this.mflag, "mflag");
      this.mflag.Name = "mflag";
      this.mflag.TabStop = false;
      this.tt.SetToolTip((Control) this.mflag, componentResourceManager.GetString("mflag.ToolTip"));
      this.mflag.Click += new EventHandler(this.mflag_Click);
      this.mbtn.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.mbtn, "mbtn");
      this.mbtn.Name = "mbtn";
      ...
      componentResourceManager.ApplyResources((object) this.ackb, "ackb");
      this.ackb.ForeColor = Color.Black;
      this.ackb.Name = "ackb";
      this.ackb.UseVisualStyleBackColor = true;
      this.atime.ForeColor = Color.Black;
      componentResourceManager.ApplyResources((object) this.atime, "atime");
      this.atime.Name = "atime";
      componentResourceManager.ApplyResources((object) this.aflag, "aflag");
      this.aflag.Name = "aflag";
      this.aflag.TabStop = false;
      this.tt.SetToolTip((Control) this.aflag, componentResourceManager.GetString("aflag.ToolTip"));
      this.aflag.Click += new EventHandler(this.aflag_Click);
      this.abtn.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.abtn, "abtn");
      this.abtn.Name = "abtn";
      this.abtn.TabStop = false;
      componentResourceManager.ApplyResources((object) this.log, "log");
      ...
      componentResourceManager.ApplyResources((object) this.grplog, "grplog");
      ...
      componentResourceManager.ApplyResources((object) this.btnlog, "btnlog");
      this.btnlog.Name = "btnlog";
      this.btnlog.TabStop = false;
      this.tt.SetToolTip((Control) this.btnlog, componentResourceManager.GetString("btnlog.ToolTip"));
      ...
      this.tt.SetToolTip((Control) this.pictureBox1, componentResourceManager.GetString("pictureBox1.ToolTip"));
      this.pictureBox1.Click += new EventHandler(this.pictureBox1_Click);
      this.pb_autosave.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.pb_autosave, "pb_autosave");
      this.pb_autosave.Name = "pb_autosave";
      this.pb_autosave.TabStop = false;
      this.tt.SetToolTip((Control) this.pb_autosave, componentResourceManager.GetString("pb_autosave.ToolTip"));
      this.pb_hideproc.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.pb_hideproc, "pb_hideproc");
      this.pb_hideproc.Name = "pb_hideproc";
      this.pb_hideproc.TabStop = false;
      this.tt.SetToolTip((Control) this.pb_hideproc, componentResourceManager.GetString("pb_hideproc.ToolTip"));
      this.btnsettings.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.btnsettings, "btnsettings");
      this.btnsettings.Name = "btnsettings";
      this.btnsettings.TabStop = false;
      this.tt.SetToolTip((Control) this.btnsettings, componentResourceManager.GetString("btnsettings.ToolTip"));
      this.btnsettings.Click += new EventHandler(this.btnsettings_Click);
      this.btnsave.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.btnsave, "btnsave");
      this.btnsave.Name = "btnsave";
      this.btnsave.TabStop = false;
      this.tt.SetToolTip((Control) this.btnsave, componentResourceManager.GetString("btnsave.ToolTip"));
      this.btnsave.Click += new EventHandler(this.btnsave_Click);
      this.ctrlBtn.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.ctrlBtn, "ctrlBtn");
      this.ctrlBtn.Name = "ctrlBtn";
      this.ctrlBtn.TabStop = false;
      this.tt.SetToolTip((Control) this.ctrlBtn, componentResourceManager.GetString("ctrlBtn.ToolTip"));
      ...
      this.tt.SetToolTip((Control) this.pictureBox2, componentResourceManager.GetString("pictureBox2.ToolTip"));
      this.pictureBox2.Click += new EventHandler(this.pictureBox2_Click);
      componentResourceManager.ApplyResources((object) this.label1, "label1");
      this.label1.ForeColor = Color.Green;
      this.label1.Name = "label1";
      this.tt.SetToolTip((Control) this.label1, componentResourceManager.GetString("label1.ToolTip"));
      this.pictureBox8.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.pictureBox8, "pictureBox8");
      this.pictureBox8.Name = "pictureBox8";
      this.pictureBox8.TabStop = false;
      this.tt.SetToolTip((Control) this.pictureBox8, componentResourceManager.GetString("pictureBox8.ToolTip"));
      this.sqlpic.Cursor = Cursors.Hand;
      componentResourceManager.ApplyResources((object) this.sqlpic, "sqlpic");
      this.sqlpic.Name = "sqlpic";
      this.sqlpic.TabStop = false;
      this.tt.SetToolTip((Control) this.sqlpic, componentResourceManager.GetString("sqlpic.ToolTip"));
      this.sqlpic.Click += new EventHandler(this.sqlpic_Click);
      componentResourceManager.ApplyResources((object) this.ckbhide, "ckbhide");
      ...
      componentResourceManager.ApplyResources((object) this.ckbsave, "ckbsave");
      ...
      componentResourceManager.ApplyResources((object) this.saveLogToolStripMenuItem, "saveLogToolStripMenuItem");
